...
<body>
    ...
    <a href="../../controllers/educateur/IndexEducateurController.php">Retour à la liste des contacts</a>
    <hr>

    <?php if ($educateur): ?>
        <p>
            Voulez-vous vraiment supprimer l'éducateur "<?php echo $educateur->getEmail(); ?>
             <?php echo $educateur->getMotDePasse(); ?>"
            dont le numéro de licencié est : <?php echo $licencie->getEducateurByLicencieId(); ?>?
        </p>
